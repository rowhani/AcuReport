...
acuCmapError   = "ERROR from acuCmap module"

#===========================================================================
#
# Color map Legend data
#
#===========================================================================
...
_default = (
    ...
    (0.0000,    1.0000,    0.2902),
    (0.0000,    1.0000,    0.2745),
    (0.0000,    1.0000,    0.2588),
    (0.0000,    1.0000,    0.2431),
    (0.0000,    1.0000,    0.2275),
    (0.0000,    1.0000,    0.2118),
    (0.0000,    1.0000,    0.1961),
    (0.0000,    1.0000,    0.1804),
    (0.0000,    1.0000,    0.1647),
    (0.0000,    1.0000,    0.1490),
    (0.0000,    1.0000,    0.1333),
    (0.0000,    1.0000,    0.1176),
    (0.0000,    1.0000,    0.1020),
    (0.0000,    1.0000,    0.0863),
    (0.0000,    1.0000,    0.0706),
    (0.0000,    1.0000,    0.0549),
    (0.0000,    1.0000,    0.0392),
    (0.0000,    1.0000,    0.0235),
    (0.0000,    1.0000,    0.0078),
    (0.0078,    1.0000,    0.0000),
    (0.0235,    1.0000,    0.0000),
    (0.0392,    1.0000,    0.0000),
    (0.0549,    1.0000,    0.0000),
    (0.0706,    1.0000,    0.0000),
    (0.0863,    1.0000,    0.0000),
    (0.1020,    1.0000,    0.0000),
    (0.1176,    1.0000,    0.0000),
    (0.1333,    1.0000,    0.0000),
    (0.1490,    1.0000,    0.0000),
    (0.1647,    1.0000,    0.0000),
    (0.1804,    1.0000,    0.0000),
    (0.1961,    1.0000,    0.0000),
    (0.2118,    1.0000,    0.0000),
    (0.2275,    1.0000,    0.0000),
    (0.2431,    1.0000,    0.0000),
    (0.2588,    1.0000,    0.0000),
    (0.2745,    1.0000,    0.0000),
    (0.2902,    1.0000,    0.0000),
    (0.3059,    1.0000,    0.0000),
...
colorMap                = {}
colorMap["default"]     = _default
colorMap["banded32"]    = _banded32
...
#===========================================================================
#
# Rrturn Colormap colors
#
#===========================================================================

    def getCmap(self, cmap = "default"):
        '''
	    Arguments:
	        cmap	    - color map name or values
	    Output:
	        colors      - colors
        '''
        ...
        if type(cmap) == types.StringType:
            if cmap in colorMap:
                return numarray.array(      colorMap[ cmap ]            )
            else:
                raise acuCmapError,"The cmap name <%s> is not defined" % cmap
            
        elif type(cmap) == types.ListType or type(cmap) == types.TupleType:
            return numarray.array(          cmap                        )
        
        elif isinstance( cmap, numarray.numarraycore.NumArray ):
            return cmap
        
        else:
            return numarray.array(      colorMap[ "default" ]           )
